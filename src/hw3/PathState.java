...
public class PathState implements Comparable<PathState> {
	...
	public PathState getNextChild() {
		////////////////////////////////////////////
		GridPoint nextPosition = theBoard.getGridPoint(childrenToGive.remove(0));
		...
		int childCost = theBoard.getBumpyOfTile(nextPosition) + theBoard.getWetOfTile(nextPosition);
